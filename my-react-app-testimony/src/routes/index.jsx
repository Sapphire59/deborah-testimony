...
function Index() {
  return (
    <div class="container mx-auto px-3 ">
      <div className="p-2 text-left text-md/6 leading-6">
        <div class="grid grid-cols-2 gap-3 mt-4">
          <div>
            <p class="border-1 m-4 p-2 bg-white rounded-md shadow-2xl">
              Dear Friend,
          ...
          <div>
            <p class="border-1 m-4 p-4 bg-white rounded-md shadow-2xl">
