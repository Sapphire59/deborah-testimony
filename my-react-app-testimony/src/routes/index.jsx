          ...
          <div class="grid grid-cols-2 gap-5 mt-4 p-5  ">
            ...
            <div>
              <p class="border-1 m-1 p-4 bg-white rounded-md shadow-2xl">
                ...
                on the Cross. Jesus loves you so much and its His great desire
                to heal you. I pray this site will inspire you to look into the
                Word of God and let the Holy Spirit reveal to you His wisdom on
                health and healing for you personally.
              </p>
            </div>
          </div>
